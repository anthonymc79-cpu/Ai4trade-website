...
const TUTORIALS = [
  ...
  },
  {
    ...
    duration: "8:03",
    description:
      "Run through a full EICR inspection inside Voltro, from observation codes to the signed certificate.",
    videoId: "voltro-demo-0003",
